    ...
    return (
        <article className="insta-grid-card insta-grid-card--skeleton" aria-hidden>
            ...
            <div className="insta-grid-info">
                <Skeleton variant="text" width={70} height={11} className="skeleton-block--mb-8" />
                <Skeleton variant="text" width="75%" height={18} className="skeleton-block--mb-8" />
                <Skeleton variant="text" width="100%" height={12} className="skeleton-block--mb-10" />
                <div className="insta-grid-meta insta-grid-meta--skeleton">
