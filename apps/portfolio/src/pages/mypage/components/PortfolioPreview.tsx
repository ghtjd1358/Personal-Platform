    ...
    return (
        <div className="editor-preview">
            <div className="preview-header">
                <h2>미리보기</h2>
                <Badge variant="info" className="preview-badge">실시간</Badge>
            </div>
            <div className="preview-card">
                <div className="preview-cover">
                    ...
                    {isFeatured && (
                        <Badge variant="primary" className="preview-featured-badge">Featured</Badge>
                    )}
                </div>
                    ...
                    {techStack.length > 0 && (
                        <div className="preview-tech">
                            {techStack.map((tech, index) => (
                                <Badge key={`${tech.name}-${index}`} variant="default" className="preview-tech-tag">
                                    {tech.name}
                                </Badge>
                            ))}
                        </div>
