...
const ApplicationCardSkeleton: React.FC = () => {
    return (
        <div className="kanban-card kanban-card--skeleton" aria-hidden>
            <Skeleton variant="text" width="75%" height={14} className="skel-block skel-block--mb-6" />
            <Skeleton variant="text" width="90%" height={12} className="skel-block skel-block--mb-10" />
            <Skeleton variant="text" width="60%" height={10} className="skel-block" />
        </div>
    );
};
