        ...
        <article className="post-card post-card--skeleton" aria-hidden>
            <div className="post-card-link">
                ...
                <div className="post-card-body">
                    <Skeleton variant="text" width="85%" height={22} className="skeleton-block--mb-10" />
                    <Skeleton variant="text" width="100%" height={14} className="skeleton-block--mb-6" />
                    <Skeleton variant="text" width="70%" height={14} className="skeleton-block--mb-14" />
                    <Skeleton variant="text" width="40%" height={12} className="skeleton-block" />
                </div>
            </div>
