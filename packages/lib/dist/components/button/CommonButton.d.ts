...
export interface CommonButtonProps extends Omit<ButtonHTMLAttributes<HTMLButtonElement>, 'className'> {
...
export declare const CommonButton: React.ForwardRefExoticComponent<CommonButtonProps & React.RefAttributes<HTMLButtonElement>>;
