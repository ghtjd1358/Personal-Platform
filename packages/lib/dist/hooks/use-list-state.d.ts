 ...
 */
export interface UseListStateOptions<T extends {
    id?: string;
}> {
...
export interface UseListStateReturn<T extends {
    id?: string;
}> {
    items: T[];
...
export declare function useListState<T extends {
    id?: string;
}>(options?: UseListStateOptions<T>): UseListStateReturn<T>;
