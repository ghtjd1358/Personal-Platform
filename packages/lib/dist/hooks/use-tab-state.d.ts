...
export declare function useTabState<T extends string>(initialTab: T, options?: UseTabStateOptions<T>): UseTabStateReturn<T>;
//# sourceMappingURL=use-tab-state.d.ts.map