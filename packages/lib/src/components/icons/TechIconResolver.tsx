...
import {
  ...
  SiRedux, SiReactquery, SiGit, SiWebpack, SiNpm,
  SiVscodium, SiNextdotjs, SiStyledcomponents, SiTailwindcss,
  SiSass, SiReacthookform, SiGithub, SiSupabase, SiSpringboot,
  SiMysql, SiJira, SiConfluence, SiFirebase, SiJest,
  SiPython, SiLighthouse, SiAxios, SiNodedotjs, SiJsonwebtokens,
} from 'react-icons/si';
...
const ViteIcon: React.FC = () => (
  <svg viewBox="0 0 32 32" fill="none">
    <defs>
      <linearGradient id="lib-vite-g1" x1="6" y1="3" x2="30" y2="29" gradientUnits="userSpaceOnUse">
        <stop stopColor="#41D1FF"/><stop offset="1" stopColor="#BD34FE"/>
      </linearGradient>
      <linearGradient id="lib-vite-g2" x1="19" y1="3" x2="15" y2="22" gradientUnits="userSpaceOnUse">
        <stop stopColor="#FFBD4F"/><stop offset="1" stopColor="#FF980E"/>
      </linearGradient>
    </defs>
    <path d="M29.884 6.146L16.678 29.452a.9.9 0 01-1.578.013L1.98 6.153a.9.9 0 01.996-1.312l13.091 2.56a.9.9 0 00.346 0l12.476-2.554a.9.9 0 01.995 1.299z" fill="url(#lib-vite-g1)"/>
    <path d="M22.264 2.007L12.54 3.912a.45.45 0 00-.357.417l-.578 9.824a.45.45 0 00.536.474l2.924-.588a.45.45 0 01.523.545l-.87 4.268a.45.45 0 00.548.53l1.804-.433a.45.45 0 01.548.53l-1.382 6.79a.281.281 0 00.512.209l.342-.49 6.478-12.961a.45.45 0 00-.449-.673l-3.01.478a.45.45 0 01-.5-.584l1.956-5.325a.45.45 0 00-.5-.584z" fill="url(#lib-vite-g2)"/>
  </svg>
);
...
const ICON_FACTORIES: Record<string, IconFactory> = {
  ...
  'Zustand':           () => <span role="img" aria-label="zustand">🐻</span>,
  ...
  'NodeJS':            (c) => <SiNodedotjs color={c ?? '#339933'} />,
  'Node':              (c) => <SiNodedotjs color={c ?? '#339933'} />,
  'JWT':               (c) => <SiJsonwebtokens color={c ?? '#000000'} />,
  'JSON Web Token':    (c) => <SiJsonwebtokens color={c ?? '#000000'} />,
};

// 대소문자 불일치 방어용 소문자 맵 (DB 값이 'react'로 저장된 경우 등)
const ICON_FACTORIES_LOWER: Record<string, IconFactory> = Object.fromEntries(
  Object.entries(ICON_FACTORIES).map(([k, v]) => [k.toLowerCase(), v]),
);
...
export const techIconMap: Record<string, React.ReactNode> = Object.fromEntries(
